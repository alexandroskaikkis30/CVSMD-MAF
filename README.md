# CV-SMD/MAF
This project aims to enhance the sampling of non-equilibrium protein unfolding by performing steered molecular dynamics (SMD) simulations using the constant-velocity method, and by implementing a conditional masked autoregressive flow (CNF-MAF) model for the generation of new samples.
...
<img width="1121" height="514" alt="image" src="https://github.com/user-attachments/assets/a1c7932f-ae65-49c1-a6b6-b5698aa36389" />
